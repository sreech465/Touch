...
const Ecommerce1 = ({ navigation }) => {
  ...
  const SetVisited = async() => {
    try{
      await AsyncStorage.setItem('is_ecom_visited', JSON.stringify(true));
    }catch(e){
      console.log(e);
    }
  }
  ...
  return (
    <View style={styles.container}>
      ...
      <ImageBackground
        source={require('../../Assets/assets/Group66131.jpg')}
        style={styles.image}
        resizeMode="stretch">
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              ...
              <View
                ...
                <TouchableOpacity onPress={() => navigation.push('EcommerceHome')}>
                  <View
