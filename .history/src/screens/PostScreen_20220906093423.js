    ...
    ({ item, index }) => {
      ...
      if (item.type == "all photos") {
        return <TouchableOpacity
          ...
          <Icon1 name="collections" color='gray' size={heightToDp('15')} style={{ position: 'absolute', zIndex: -10 }} />
          <View style={{ backgroundColor: 'black', justifyContent: 'center', height: '100%', width: '100%', opacity: 0.6 }}>
            <Text style={{ color: 'white', fontSize: heightToDp('3'), textAlign: 'center' }}>See All</Text>
          </View>
        </TouchableOpacity>
      }
        ...
        <View
          ...
          {/* {!mediaSelected && (
            <Icon
              ...
              size={25}
              color="white"
              onPress={() => { setMediaSelected(true); scrollToTop(); }}
            />
          )} */}
        </View>
